...
<body>
	<div class="container" style="margin-top: 30px">
		...
		<form action="#" method="post" role="form" autocomplete="off">
			...
			<div class="row">
				<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 offset-md-9">
					<input class="btn" style="background-color:#C88A7D; margin-top: 50px; margin-bottom: 50px" type="submit"
